    ...
    def train(
        ...
        **kwargs: Any,
        ...
        custom = {
            ...
            "model": self.overrides.get("model") or self.model_name or self.ckpt_path,
        ...
        if not args.get("resume"):  # manually set model only if not resuming
            # YOLO-Multispectral fork: preserve patched nn.Module graphs loaded from .pt
            # (CBAM/ECA/SpectralConv/DropBlock/GroupNorm/Wavelet wrappers).
            # Rebuilding from YAML via get_model() would drop these custom modules.
