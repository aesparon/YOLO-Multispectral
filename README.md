...
<p align="center">
  ...
  <br>
  <em>Figure 1: Example results for just RGB and RGB, red edge, and NIR multispectral weed segmentation with and without transfer learning([Dataset weeds galore](https://github.com/GFZ/weedsgalore).). Refer Colbab example below to duplicate results</em>
</p>
